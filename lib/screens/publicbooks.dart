...
//
//   @override
//   State<PublicBooksScreen> createState() => _PublicBooksScreenState(url: url);
// }
//
// class _PublicBooksScreenState extends State<PublicBooksScreen> {
//   String url;
//
//   _PublicBooksScreenState({
//     required this.url,
//   });
//
...
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:edpal/screens/publicbookssecond.dart';
import 'package:flutter/material.dart';
...
class _PublicBooksScreenState extends State<PublicBooksScreen> {
  TextEditingController title = TextEditingController();
  CollectionReference get ref => FirebaseFirestore.instance.collection('schools');
  ...
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _foldersStream = ref
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              InkWell(
                ...
                onTap: () {
                  if (title.text.isNotEmpty) {
                    ref.where('principalemail', isEqualTo: widget.principalemail).get().then((querySnapshot) {
                      for (var doc in querySnapshot.docs) {
                        doc.reference.collection('publicBooks').add({
                          'name': title.text,
                          'type': _currentItemSelected,
                        });
                      }
